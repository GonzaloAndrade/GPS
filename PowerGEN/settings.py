...
ALLOWED_HOSTS = ['genpowerservice.net']
...
ROOT_URLCONF = 'PowerGEN.urls'

WSGI_APPLICATION = 'PowerGEN.wsgi.application'
...
STATIC_ROOT = '/home1/rawrkyco/public_html/genpowerservice/static'
STATIC_URL = '/static/'